...
class InitialImageAnalysisSignature(dspy.Signature):
    ...
    security_features: str = OutputField(desc="List of security features found")
    doc_condition: str = OutputField(desc="Document condition assessment")
    ...
    def forward(self, image, reference_text):
        ...
        return {
            "first_pass": {
                ...
                "doc_condition": initial_results.doc_condition,
            ...
            "final_pass": {
                ...
                "doc_condition": final_results.doc_condition,
